                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: RaisedButton(child: Text("Contact here",style: TextStyle(fontSize: 25,color: Colors.white)),
                                      onPressed: (){
                                      launch("tel:+09611800900");
                                    },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    child: Column(
                                      children: [
                                        Container(alignment: Alignment.center,child: Text("Hotline: +09611800900",
                                          style: TextStyle(fontSize: w/20,fontWeight: FontWeight.bold,color: Colors.yellow),textAlign: TextAlign.center,)),
                                        Container(
                                          alignment: Alignment.center,
                                          child: Padding(
                                            padding: const EdgeInsets.only(left: 10.0),
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              //   child: Padding(
                                              //     padding: const EdgeInsets.only(left: 10.0),
                                              //     child: RaisedButton(child: Text("Call Support",style: TextStyle(fontSize: 25)),
                                              //     //   onPressed: (){
                                              //     //   launch("tel:+88"+office_Support[index]);
                                              //     // },
                                              //     shape: RoundedRectangleBorder(
                              ...
                              //           child: InkWell(
                              //             onTap: (){
                              //               Get.snackbar("Alart",   "Please use phone to call");
                              //             },
                              //             child: Padding(
                              //               padding: const EdgeInsets.only(left: 10.0),
                              //               child: RaisedButton(child: Text("Contact here",style: TextStyle(fontSize: 25,color: Colors.white)),
