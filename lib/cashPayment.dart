...
class _CashPaymentState extends State<CashPayment> {
  ...
  Widget build(BuildContext context) {
    ...
    if(MediaQuery.of(context).orientation==Orientation.portrait){
        ...
        return SafeArea(
          child: Scaffold(
            appBar:PreferredSize(preferredSize: Size.fromHeight(x / 15),
                child: new AppBar(title: new Text('Cash Payment', style: TextStyle(fontSize: x / 30,color: Colors.black),),
                  centerTitle: true,
      ...
      //           width: size.width,
      //           child: Container(
      //             child: ListView.builder(itemCount: data_address.length,
      //                 itemBuilder: (context,index){
      //                   return Padding(
      //                     padding:  EdgeInsets.all(w/25),
      //                     child: Container(
      ...
      //                                 launch("tel:"+data_address[index]["sales"]);
      //                               },
      //                                 shape: RoundedRectangleBorder(
      //                                     borderRadius: BorderRadius.circular(18.0),
      //                                     side: BorderSide(color: Colors.black)),
           ...
           Scaffold(
            appBar: PreferredSize(preferredSize: Size.fromHeight(size.height/9),
                child: new AppBar(
                  ...
                  title: new Text('Cash Payment', style: TextStyle(fontSize: w / 30,color: Colors.black),),
                  centerTitle: true,
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      //   child: Padding(
                                      //     padding: const EdgeInsets.only(right: 10.0),
                                      //     child: RaisedButton(child: Text("Call Sales",style: TextStyle(fontSize: 25),),
                                      //       // onPressed: (){
                                      //       // launch("tel:+88"+office_Sales[index]);
                                      //       // },
                                      //       shape: RoundedRectangleBorder(
